                ...
                children: <Widget>[
                  ClipRRect(
                      ...
                      child: CommonUis.getCircularImageAvatar(
                          widget.doctor.profile_pic!, 50, 50)),
                  SizedBox(
                    width: 10,
                  ),
                  Expanded(
                    ...
                    children: [
                      ...
                      CommonUis.getText("${widget.doctor.specialization}",
                          AppColors.themeColorDark, AppFontSize.size16,
                          weight: AppFontsStyle.REGULAR),
                      CommonUis.getText("${widget.doctor.description}",
                          AppColors.black, AppFontSize.size14,
                          weight: AppFontsStyle.REGULAR, maxLines: 2),
                    ],
                  )),
                  SizedBox(
                    width: 10,
              ...
              widget.doctor.isEdited!
                  ? Align(
                      ...
                      child: CommonUis.getText(
                          "EDITED", AppColors.redTxt, AppFontSize.size14,
                          weight: AppFontsStyle.REGULAR),
                    )
                  : SizedBox(
                      height: 0,
