...
class CommonUis {
  ...
  static Container getThemeRaisedButtonDisabled(
      String text, Function() onButtonPressed,
      {double height = 50.0}) {
    return Container(
      margin: EdgeInsets.only(right: 10, left: 10),
      width: double.infinity,
  ...
  static Container getThemeRaisedButtonNegative(
      String text, Function() onButtonPressed,
      {double height = 50.0}) {
    return Container(
      margin: EdgeInsets.only(right: 10, left: 10),
  ...
  static Widget getButton(String text,
    ...
    return Container(
      ...
      child: ElevatedButton(
          ...
          child: CommonUis.getText(text, textColor, fontSize,
              font: font, alignment: TextAlign.center)),
    );
  }

  static Container getCommonTextField(
      {String hint = "",
      String? text,
    ...
    return Container(
      ...
      child: Theme(
        data: ThemeData(
            primaryColor: AppColors.black, hintColor: AppColors.greyTxt),
        child: TextField(
          autofocus: false,
          readOnly: readOnly,
  ...
  static Container getCommonTextFieldWithHeader(
      {String hint = "",
      String? text,
      TextEditingController? controller,
      TextInputType textInputType = TextInputType.text,
  ...
  static getCircularImageAvatar(String imageUrl, double height, double width,
